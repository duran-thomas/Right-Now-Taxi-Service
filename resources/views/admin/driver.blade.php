                        ...
                        <table class="table col-md" id="laravel_datatable">
                            <thead class="thead-primary">
                                <tr class="table-primary">
                                    ...
                                    <th scope="col" class="text-center">Assigned Routes </th>                 
                            ...
                            <tbody>
                                @foreach($driver as $driver)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button class="btn btn-secondary" >
                                                <span><i class="mdi  mdi-format-list-bulleted"></i></span> Routes
                                            </button>
                                        </td>
                                        <td class="text-center">{{$driver->status}}</td>
                                        <td>
                                            <button class="edit-modal btn btn-primary" data-toggle="modal" data-target="#editDriver"
                                        data-driverID="{{$driver->driverID}}" data-name="{{$driver->name}}" data-address="{{$driver->address}}" data-contact="{{$driver->contact}}" data-status="{{$driver->status}}"
                                        data-vehicleModel="{{$vehicle->vehicleModel}}" data-vehicleYear="{{$vehicle->vehicleYear}}" data-lisencePlate="{{$vehicle->lisencePlate}}" data-routes="{{$routes->routes}}">
                                            <span><i class="mdi mdi-comment-text-outline"></i></span> Edit
                                            </button>
                                            <button class="delete-modal btn btn-danger" data-toggle="modal" data-target="#deleteOrder">
