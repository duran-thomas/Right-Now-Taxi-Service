...
<head>
  ...
  <title>Welcome: Right Now Taxi</title>
  <meta charset="utf-8">
...
<div id="services" class="container-fluid text-center">
  ...
  <div class="row slideanim">
    <div class="col-sm-4">
      ...
      <h4>COMFORT</h4>
      <p>Air-conditioned car & bus service </p>
    </div>
    <div class="col-sm-4">
      <span class="glyphicon glyphicon-certificate logo-small"></span>
      <h4>CONVENIENT</h4>
      <p>Airport drop-off and pick-up </p>
    </div>
    <div class="col-sm-4">
      <span class="glyphicon glyphicon-certificate logo-small"></span>
      <h4>TOP OF THE LINE</h4>
      <p>Premium Service </p>
    </div>
  </div>
  <br><br>
  <div class="row slideanim">
    <div class="col-sm-4">
      ...
      <p>Advanced Courier Services  </p>
    </div>
    <div class="col-sm-4">
      <span class="glyphicon glyphicon-certificate logo-small"></span>
      <h4>EASY</h4>
      <p>Booking with wake-up call </p>
    </div>
    <div class="col-sm-4">
      <span class="glyphicon glyphicon-certificate logo-small"></span>
      <h4 style="color:#303030;">MEET YOUR NEEDS</h4>
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p>Monday - Saturday</p>
      <p><span class="glyphicon glyphicon-map-marker"></span> Half Way Tree, Kingston</p>
...
<footer class="container-fluid text-center">
  ...
  <p><span>&copy;</span> Right Now Taxi Service</p>
  <p>2019</p>
</footer>
<script>
